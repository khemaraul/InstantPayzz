...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    @foreach($dataslips as $dataslips)
    <div class="container-fluid">
    <center><u><h4 style="color: #808080;">Payslip</h4></u></center>
    <div>
    <!--<img src="{{ asset('/bower_components/AdminLTE/dist/img/hr_logo1.png') }}" style="border-radius: 50%;border: 2px solid #2B0F0E;float: left;" width="100px" height="100px">-->
    <img src="https://media1.thehungryjpeg.com/thumbs2/ori_3657518_jh3knols1s5hhc0ua2q3zoky4i05m9djgc2wemkz_monogram-hr-logo-design.jpg" style="border-radius: 50%;border: 2px solid #2B0F0E;float: left;" width="100px" height="100px">
