...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Uploaded Payrolls
      </h1>
      <ol class="breadcrumb">
        <!-- li><a href="#"><i class="fa fa-dashboard"></i> Level</a></li-->
        <li class="active">View Uploaded Payrolls</li>
      </ol>
    </section><br />
    ...
    @endif
    <center>
    <a href="{{ route('sendMail') }}" class="btn btn-primary" id="btnprn">Send All Payslips</a></center>
    ...
    $(document).ready(function(){
      ...
      $('#payrollTable').DataTable({
         processing: true,
         serverSide: true,
         ajax: "{{route('list-uploaded-payroll.getUploadedpayroll')}}",
         columns: [
            { data: 'id' },
            { data: 'emp_no' },
            { data: 'emp_name' },
            ...
            //return "<a href='{{route('payroll-payslip')}}/"+ row.id +"'>Payslips</a>";
            return "<a href='/payroll/payslips?id="+ row.id +"'>Payslips</a>";
            }},
         ]
      });
...
<!--<script>
    ...
    {
    $.ajax({
    url:"/list-employees/fetch_data?page="+page,
